...
const bd_AdamSul = new CronJob(
  '56 13 12 05 *', // cronTime
  function () {
    bot.api.sendMessage(
      chatId,
      'Коллеги, сегодня у нас праздник — день рождения Адама! 🎉🎂 Давайте поздравим его и пожелаем ярких идей, креативного вдохновения и только удачных проектов! 💻✨ \n\n  Пусть каждый логотип становится символом успеха, а соцсети набирают популярность и радуют подписчиков! 👍💡 Желаем Адаму энергии, отличного настроения и много поводов для радости как в работе, так и в жизни! \n\n Счастья, здоровья и новых творческих свершений! 🎊🥳🚀'
    );
  }, // onTick
  null, // onComplete
  true, // start
